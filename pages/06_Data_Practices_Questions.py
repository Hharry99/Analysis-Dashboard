...
/* Data Practices Questions fallback override for grouped navigation visibility */
...
st.caption(
    "Takeaway: The chart shows the top response categories for the selected question. Full response details remain available in the summary table below."
)
...
try:
    ...
    st.page_link(
        ...
        label="Next suggested page: Forecasting Questions",
        icon="➡️"
    )
    ...
    st.caption(
        "Next suggested page: Forecasting Questions →"
    )
