...
/* Forecasting Maturity fallback override for grouped navigation visibility */
...
st.caption(
    "Takeaway: The distribution shows that forecasting maturity varies across respondents, with several responses falling in the developing and higher maturity ranges."
)
...
st.caption(
    "Takeaway: MTRD records the highest average FMI, while KURA records the lowest average FMI among the participating agencies."
)
...
st.caption(
    "Takeaway: The heatmap provides a compact scorecard view of agency-level FMI performance."
)
...
try:
    ...
    st.page_link(
        ...
        label="Next suggested page: Reconstruction Readiness",
        icon="➡️"
    )
    ...
    st.caption(
        "Next suggested page: Reconstruction Readiness →"
    )
